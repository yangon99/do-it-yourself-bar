...
Rectangle {
    ...
    Rectangle {
        ...
        color: {
            if (style == "A") {
                return config.BlockIndicatorsCustomColorForStyleA || PlasmaCore.Theme.textColor;
            }
            if (style == "B") {
                return config.BlockIndicatorsCustomColorForStyleB || PlasmaCore.Theme.buttonFocusColor;
            }
            if (style == "C") {
    ...
    Text {
        ...
        color: {
            ...
            if (parent.style == "A") {
                return config.BlockLabelsCustomColorForStyleA || PlasmaCore.Theme.textColor;
            }
            if (parent.style == "B") {
                return config.BlockLabelsCustomColorForStyleB || PlasmaCore.Theme.textColor;
            }
            if (parent.style == "C") {
                return config.BlockLabelsCustomColorForStyleC || PlasmaCore.Theme.textColor;
            }
            return theme.textColor;
        }
        ...
        font.family: config.BlockLabelsCustomFont || PlasmaCore.Theme.defaultFont.family
        font.pixelSize: config.BlockLabelsCustomFontSize || PlasmaCore.Theme.defaultFont.pixelSize
    }
